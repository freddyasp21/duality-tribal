    ...
    <nav class="bg-white text-black sticky top-0 z-50 border-b border-gray-200" aria-label="Navegación principal">
        <div class="w-full lg:w-[80%] mx-auto px-4 lg:px-0">
            <div class="flex items-center justify-between h-16">
                ...
                <!-- Sección Izquierda: Logo Duality Tribal y Enlaces -->
                <div class="flex items-center space-x-8 h-16">
                    <div class="flex-shrink-0 flex items-center">
                        <Link :href="route('home')"
                            ...
                            <span
                                class="bg-purple-900 text-white px-1.5 py-0.5 rounded-sm mr-2 text-xs font-bold">DT</span>
                ...
                <!-- Sección Derecha: Buscador y Auth -->
                <div class="flex items-center h-16">
                    <div class="relative hidden md:block mr-6 group">
                        <input type="text" placeholder="Buscar..."
                            class="bg-gray-100 text-gray-900 pl-3 pr-9 py-1.5 text-xs rounded-full border border-transparent focus:border-gray-200 focus:bg-white focus:outline-none w-40 focus:w-60 transition-all duration-300 placeholder-gray-400" />
                    </div>
                    ...
                    <div class="hidden md:flex items-center h-16">
                        ...
                        <template v-else>
                            <Link :href="route('login')"
                                class="bg-[#00df89] text-black h-16 px-6 flex items-center font-bold text-xs hover:bg-[#00c478] transition-colors">
                                Inicia sesión</Link>
                            <Link :href="route('register')"
                                class="bg-[#5900cc] text-white h-16 px-6 flex items-center font-bold text-xs hover:bg-[#4a00b0] transition-colors">
                                Regístrate</Link>
                        </template>
                    </div>
                </div>
